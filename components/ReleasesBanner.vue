        ...
        <div class="releases-banner__image">
            <picture>
                <source media="(max-width: 930px)" 
                   srcset="https://www.nike.qa/dw/image/v2/BDVB_PRD/on/demandware.static/-/Library-Sites-NikeSharedLibrary/default/dw01498204/2024/10/Women/WLP%20P1_img_MB-min.jpg?q=80" />
                   <img src="https://www.nike.qa/dw/image/v2/BDVB_PRD/on/demandware.static/-/Library-Sites-NikeSharedLibrary/default/dw2a0e2b47/2024/10/Women/WLP%20P1_img_DT-min.jpg?q=80"
...
.releases-banner {
    ...
    &__btn {
        ...
        &:hover {
            cursor: pointer;
            background-color: color.adjust($color-dark-gray, $lightness: 0.5%);
        }
    }
