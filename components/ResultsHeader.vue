<template>
      ...
      <nav class="products-header__navigation">
        <button class="products-header__toggle-button">
          <span class="products-header__toggle-label" @click="toggleFilter">
            <span class="products-header__toggle-label__bold">{{
        ...
        <div class="products-header__dropdown">
          <div
            class="products-header__dropdown-trigger"
            @click="toggleBoxFilters"
          >
          ...
          <div class="products-header__dropdown-menu">
            <ul class="products-header__list">
              <li
                class="products-header__list-item"
                :class="{
                  'products-header__list-item--active':
                    sortByValue === 'Price: Low-High'
                }"
                @click="
                  sortByPriceLowHigh('Price: Low-High');
                  toggleBoxFilters();
                "
              >
                Price: Low-High
              ...
              <li
                ...
                :class="{
                  'products-header__list-item--active':
                    sortByValue === 'Price: High-Low'
                }"
                @click="
                  sortByPriceHighLow('Price: High-Low');
                  toggleBoxFilters();
                "
              >
                Price: High-Low
  ...
  <div class="products-header__categories" v-if="categories.length">
    <span
      class="products-header__category-value"
...
const toggleBoxFilters = () => {
  const dropdownMenu = document.querySelector(
    '.products-header__dropdown-menu'
  );
...
const removeCategory = (category) => {
  filtersStore.selectedFilters.categoryFilters =
    filtersStore.selectedFilters.categoryFilters.filter(
      (item) => item !== category
    );
};
